...
| [`milestone-3.md`](milestone-3.md) | The M3 plan (`v0.3.0-m3`, in progress) — write & safety: the recon decisions (write workflow, annotation overrides, BearerResolver, property-sheet edit, history-viewer scope, e2e fixture), then commits C48–C60 in four phases with check-in points. |
...
`docs/m3-followups.md` will be added when M3 closes.
