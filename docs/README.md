...
| [`milestone-4.md`](milestone-4.md) | The M4 plan (`v0.4.0-m4`, in progress) — observability: the recon decisions (charting lib, live-monitor state model, history-viewer scope, watch persistence, perf-timeline data source, tool-usage stats, chart-primitives reuse for M5), commits C61–C68 in four phases. |
...
| [`screenshots/`](screenshots/) | Check-in / milestone-boundary snapshots of the running app (captured via the `MCPSTUDIO_CAPTURE_PATH` main-process hook). `screenshots/README.md` indexes them. (M2 Explorer/BQL + M3 write-flow captures are still TODO — see the repo README.) |
